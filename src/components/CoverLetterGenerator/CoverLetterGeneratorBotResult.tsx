...
import { getCoverLetter } from "./CoverLetterGeneratorData.ts";
import { formatResultText } from "../../utils/textutils.ts";

const CoverLetterGeneratorBotResult = () => {
  ...
  useEffect(() => {
    async function fetch() {
      if (coverLetterId) {
        const response = await getCoverLetter(coverLetterId);
...
export default CoverLetterGeneratorBotResult;
