...
import { getPerformanceReview } from "./PerformanceReviewGeneratorData.ts";
import { formatResultText } from "../../utils/textutils.ts";

const PerformanceReviewGeneratorResult = () => {
  ...
  useEffect(() => {
    async function fetch() {
      if (performanceReviewId) {
        const response = await getPerformanceReview(performanceReviewId);
...
export default PerformanceReviewGeneratorResult;
