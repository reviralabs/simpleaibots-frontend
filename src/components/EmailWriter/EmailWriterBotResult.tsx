...
import { getEmailContent } from "./EmailWriterData.ts";
import { formatResultText } from "../../utils/textutils.ts";

const EmailWriterBotResult = () => {
  ...
  useEffect(() => {
    async function fetch() {
      if (emailContentId) {
        const response = await getEmailContent(emailContentId);
...
export default EmailWriterBotResult;
